"""template_modules_25880 URL Configuration
...
admin.site.site_header = "template-modules"
admin.site.site_title = "template-modules Admin Portal"
admin.site.index_title = "template-modules Admin"

# swagger
api_info = openapi.Info(
    title="template-modules API",
    default_version="v1",
    description="API documentation for template-modules App",
)
